...
public class SmallTestExamples {
    ...
    public void Screenshot1() {
        ...
        onView(withId(R.id.textEncryptedID)).check(matches(withText("62Z & BAW")));
    }
    ...
    public void Screenshot3() {
        ...
        replaceTextHelper(R.id.argInput2ID, "1");
        onView(withId(R.id.encryptButtonID)).perform(click());
        onView(withId(R.id.textEncryptedID)).check(matches(withText("v05AFKP")));
    }
    ...
    public void trigger() {
        ...
        replaceTextHelper(R.id.argInput2ID, "1");
        onView(withId(R.id.encryptButtonID)).perform(click());
        onView(withId(R.id.textEncryptedID)).check(matches(withText("__SIZPPFI__")));
    }
    ...
    public void gradingTest13() {
        ...
        replaceTextHelper(R.id.argInput2ID, "1");
        onView(withId(R.id.encryptButtonID)).perform(click());
        onView(withId(R.id.textEncryptedID)).check(matches(withText("INCUN TNQ")));
    }
}

...
public interface MyStringInterface {
     ...
     *   This input should be an integer co-prime to 62 between 0 and 61: 1, 3, 5, 7, 
     *   9, 11, 13, 15, ... 61
     ...
     *   in the alphabet (i.e., "0"=0, "1"=1, ..., "9"=9, "A"=10, "B"=11, ..., "Z"=35, "a"=36, "b"=37, ..., "z"=61)
     ...
     *   (again, where "0"=0, "1"=1, ..., "9"=9, "A"=10, "B"=11, ..., "Z"=35, "a"=36, "b"=37, ..., "z"=61).
     ...
     *   Arg Input 2 = 3
     * - Output:
     *   Text Encrypted = "1xU & S 65RJ"
     * - Explanation:
     *   "C" has value 12, (12 * 5 + 3) % 62 = 1, 1 corresponds to "1".
     *   "a" has value 36, (36 * 5 + 3) % 62 = 59, 59 corresponds to "x".
     *   …
     *   " ", "&", and " " are unchanged
     *   "5" has value 5, (5 * 5 + 3) % 62 = 28, 28 corresponds to "S".
     *   " " is unchanged
     *   …
     *
